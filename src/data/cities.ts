...
export const cities: City[] = [
  {
    ...
    venues: ['Locations an der Weser', 'Hofgüter & Scheunen im Bremer Umland', 'Eventlofts in der Überseestadt', 'Landhäuser im Blockland'],
  },
  {
    slug: 'frankfurt',
    name: 'Frankfurt',
    ...
    local: 'Im Rhein-Main-Gebiet bin ich regelmäßig im Einsatz. Frankfurt bietet von der eleganten Stadt-Location bis zum rustikalen Weingut alles — und für jede dieser Kulissen bringe ich das passende Setup mit. Kurze Wege, verlässliche Technik und eine Musikauswahl, die internationale Gäste genauso abholt wie die Familie aus der Region.',
    venues: ['Eventlocations im Bankenviertel', 'Weingüter im Rheingau (Anfahrt)', 'Hofgüter im Taunus-Vorland', 'Villen & Säle im Frankfurter Umland'],
  },
  {
    slug: 'mainz',
    name: 'Mainz',
